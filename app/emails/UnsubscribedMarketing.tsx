...
export default function UnsubscribedMarketing({
  ...
  resubscribeUrl = "https://loft-ai-002-unsubscribe.vercel.app/unsubscribe?email=" + userEmail,
            ...
            >
              ...
              >
                ...
                <Section style={{ padding: '0 24px 32px 24px', backgroundColor: '#ffffff' }}>
                  ...
                  <Text style={{ fontSize: '16px', color: '#374151', margin: '0 0 16px 0' }}>
                    <b>Your Loft subscription is still active</b>, and you’ll continue to have full access to all your saved content, summaries, and smart search features.
                  </Text>
                  <Text style={{ fontSize: '16px', color: '#374151', margin: '0 0 16px 0' }}>
