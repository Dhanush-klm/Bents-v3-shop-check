            ...
            >
              ...
              >
                ...
                <Section style={{
                  ...
                  >
                    Your Loft subscription renews next week
                  </Text>
                  <Text style={{ 
                    fontSize: '16px', 
                    color: '#6b7280', 
                    ...
                    Just a quick reminder about your upcoming renewal
                  </Text>
                </Section>
                {/* Main Content */}
                <Section style={{ padding: '0 24px 32px 24px', backgroundColor: '#ffffff' }}>
                  ...
                  <Text style={{ fontSize: '16px', color: '#374151', margin: '0 0 16px 0' }}>
                    Your Loft Pro subscription is set to renew on{' '}
                    <span style={{ fontWeight: 600, color: '#111827' }}>{renewalDate}</span>.
                  </Text>
