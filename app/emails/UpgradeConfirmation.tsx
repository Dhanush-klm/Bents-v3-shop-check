            ...
            >
              ...
              >
                ...
                <Section style={{ padding: '0 24px 32px 24px', backgroundColor: '#ffffff' }}>
                  ...
                  <Text style={{ fontSize: '16px', color: '#374151', margin: '0 0 8px 0' }}>
                    ...
                    <div style={{
                      ...
                      <div>
                        <Text style={{
                          ...
                          Unlimited saves – No more limits on what you can collect
                        </Text>
                      </div>
                    </div>
                    <div style={{
                    ...
                    <div style={{
                      ...
                      <div>
                        <Text style={{
                          ...
                          Smart resurfacing – Loft remembers and brings your links back when you need them
                        </Text>
                      </div>
                    </div>
                    <div style={{
                  ...
                  <div style={{ margin: '16px 0 24px 0', textAlign: 'center' }}>
                    ...
                    >
                      <span style={{
                        ...
                        <span>Start using your new features today</span>
                      </span>
                    </Link>
                  </div>
