              ...
              >
                ...
                <Section style={{
                  ...
                  <Text style={{
                    ...
                    Your smarter, AI-powered way to save links
                  </Text>
                </Section>
                {/* Main Content */}
                <Section style={{
                      ...
                      <tr>
                        <td>
                          ...
                          <Text style={{
                            ...
                            <span style={{fontFamily: 'Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji'}}>🎉</span>
                          </Text>
                          <Text style={{
                            fontSize: '16px',
                            color: '#374151',
                            ...
                            <div style={{
                              ...
                              <div>
                                <Text style={{
                                  ...
                                  Unlimited saves – Collect as much as you want
                                </Text>
                              </div>
                            </div>
                            <div style={{
                              ...
                              <div>
                                <Text style={{
                                  ...
                                  AI-powered summaries – Instantly understand your saved content
                                </Text>
                              </div>
                            </div>
                            <div style={{
                              ...
                              <div>
                                <Text style={{
                                  ...
                                  Smart resurfacing – Loft remembers what you saved and brings it back when you need it
                                </Text>
                              </div>
                            </div>
                            <div style={{
                              ...
                              <div>
                                <Text style={{
                                  ...
                                  Advanced organization – Create your own collections or let Loft intelligently curate them for you
                                </Text>
                              </div>
                            </div>
                            <div style={{
                              ...
                              <div>
                                <Text style={{
                                  ...
                                  AI-powered tags – Links are automatically categorized for effortless discovery
                                </Text>
                              </div>
                            </div>
                          </div>
                            ...
                            <div style={{
                              ...
                              <div>
                                ...
                                <Text style={{
                                  ...
                                  <Link href="https://loftit.ai/ios-share-extension" style={{ color: '#2563eb', textDecoration: 'underline' }}>
                          ...
                          <div style={{ margin: '16px 0 32px 0', textAlign: 'center' }}>
                            ...
                            >
                              <span style={{
                                ...
                                <span>Start exploring Loft Pro today</span>
                              </span>
                            </Link>
                          </div>
