            ...
            >
              ...
              >
                ...
                <Section style={{
                  ...
                  >
                    Your Loft Pro subscription has been canceled
                  </Text>
                  <Text style={{ 
                    fontSize: '16px', 
                    color: '#6b7280', 
                ...
                <Section style={{ padding: '0 24px 32px 24px', backgroundColor: '#ffffff' }}>
                  ...
                  <Text style={{ fontSize: '16px', color: '#374151', margin: '0 0 16px 0' }}>
                    Your account is still active, and you&apos;ll continue to have access to all your saved links — but premium features like AI summaries, smart resurfacing, and unlimited saves will be paused once your current billing cycle ends on{' '}
                    <span style={{ fontWeight: 600, color: '#111827' }}>{endDate}</span>.
                  </Text>
                    ...
                    <div style={{ margin: '16px 0' }}>
                      ...
                      >
                        <span style={{
                          ...
                          <span>Re-Upgrade to Loft Pro</span>
                        </span>
                      </Link>
                    </div>
                  </div>
