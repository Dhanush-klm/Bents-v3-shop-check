            ...
            >
              ...
              >
                ...
                <Section style={{
                  ...
                  >
                    Your Loft Pro trial ends tomorrow
                  </Text>
                </Section>
                {/* Main Content */}
                <Section style={{ padding: '0 24px 32px 24px', backgroundColor: '#ffffff' }}>
                  ...
                  <Text style={{ fontSize: '16px', color: '#374151', margin: '0 0 24px 0' }}>
                    Your{' '}
                    <span style={{ fontWeight: 600, color: '#111827' }}>Loft Pro free trial</span>{' '}
                    ends{' '}
                    <span style={{ fontWeight: 600, color: '#dc2626' }}>tomorrow</span>, and your subscription will begin automatically after that.
                  </Text>
                  ...
                  {/* Features list with sparkle emojis */}
                  <div style={{
